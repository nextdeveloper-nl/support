 ...
 */
class AbstractKbArticlesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(KbArticles $model)
    {
    ...
    public function includeActions(KbArticles $model)
    {
    ...
    public function includeMedia(KbArticles $model)
    {
    ...
    public function includeSocialMedia(KbArticles $model)
    {
    ...
    public function includeComments(KbArticles $model)
    {
    ...
    public function includeVotes(KbArticles $model)
    {
    ...
    public function includeMeta(KbArticles $model)
    {
    ...
    public function includePhoneNumbers(KbArticles $model)
    {
    ...
    public function includeAddresses(KbArticles $model)
    {
