 ...
 */
class AbstractCsatsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Csats $model)
    {
    ...
    public function includeActions(Csats $model)
    {
    ...
    public function includeMedia(Csats $model)
    {
    ...
    public function includeSocialMedia(Csats $model)
    {
    ...
    public function includeComments(Csats $model)
    {
    ...
    public function includeVotes(Csats $model)
    {
    ...
    public function includeMeta(Csats $model)
    {
    ...
    public function includePhoneNumbers(Csats $model)
    {
    ...
    public function includeAddresses(Csats $model)
    {
