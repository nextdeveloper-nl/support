 ...
 */
class AbstractAgentExpertisesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(AgentExpertises $model)
    {
    ...
    public function includeActions(AgentExpertises $model)
    {
    ...
    public function includeMedia(AgentExpertises $model)
    {
    ...
    public function includeSocialMedia(AgentExpertises $model)
    {
    ...
    public function includeComments(AgentExpertises $model)
    {
    ...
    public function includeVotes(AgentExpertises $model)
    {
    ...
    public function includeMeta(AgentExpertises $model)
    {
    ...
    public function includePhoneNumbers(AgentExpertises $model)
    {
    ...
    public function includeAddresses(AgentExpertises $model)
    {
