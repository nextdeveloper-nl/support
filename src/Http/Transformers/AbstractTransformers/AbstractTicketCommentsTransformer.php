...
class AbstractTicketCommentsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(TicketComments $model)
    {
    ...
    public function includeActions(TicketComments $model)
    {
    ...
    public function includeMedia(TicketComments $model)
    {
    ...
    public function includeSocialMedia(TicketComments $model)
    {
    ...
    public function includeComments(TicketComments $model)
    {
    ...
    public function includeVotes(TicketComments $model)
    {
    ...
    public function includeMeta(TicketComments $model)
    {
    ...
    public function includePhoneNumbers(TicketComments $model)
    {
    ...
    public function includeAddresses(TicketComments $model)
    {
