 ...
 */
class AbstractKbArticlesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(KbArticlesPerspective $model)
    {
    ...
    public function includeActions(KbArticlesPerspective $model)
    {
    ...
    public function includeMedia(KbArticlesPerspective $model)
    {
    ...
    public function includeSocialMedia(KbArticlesPerspective $model)
    {
    ...
    public function includeComments(KbArticlesPerspective $model)
    {
    ...
    public function includeVotes(KbArticlesPerspective $model)
    {
    ...
    public function includeMeta(KbArticlesPerspective $model)
    {
    ...
    public function includePhoneNumbers(KbArticlesPerspective $model)
    {
    ...
    public function includeAddresses(KbArticlesPerspective $model)
    {
