 ...
 */
class AbstractTicketsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(TicketsPerspective $model)
    {
    ...
    public function includeActions(TicketsPerspective $model)
    {
    ...
    public function includeSocialMedia(TicketsPerspective $model)
    {
    ...
    public function includeComments(TicketsPerspective $model)
    {
    ...
    public function includeVotes(TicketsPerspective $model)
    {
    ...
    public function includeMeta(TicketsPerspective $model)
    {
    ...
    public function includePhoneNumbers(TicketsPerspective $model)
    {
    ...
    public function includeAddresses(TicketsPerspective $model)
    {
