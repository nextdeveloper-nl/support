...
class AbstractTicketsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Tickets $model)
    {
    ...
    public function includeActions(Tickets $model)
    {
    ...
    public function includeMedia(Tickets $model)
    {
    ...
    public function includeSocialMedia(Tickets $model)
    {
    ...
    public function includeComments(Tickets $model)
    {
    ...
    public function includeVotes(Tickets $model)
    {
    ...
    public function includeMeta(Tickets $model)
    {
    ...
    public function includePhoneNumbers(Tickets $model)
    {
    ...
    public function includeAddresses(Tickets $model)
    {
