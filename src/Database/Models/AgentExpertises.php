...
use NextDeveloper\Support\Database\Observers\AgentExpertisesObserver;
 ...
 */
class AgentExpertises extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(AgentExpertisesObserver::class);
