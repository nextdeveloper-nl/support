...
class TicketsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Support\Tickets', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Support\Tickets', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Support\Tickets', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Support\Tickets', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Support\Tickets', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Support\Tickets', $model);
    }
