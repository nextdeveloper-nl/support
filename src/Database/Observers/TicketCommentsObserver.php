...
class TicketCommentsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Support\TicketComments', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Support\TicketComments', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Support\TicketComments', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Support\TicketComments', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Support\TicketComments', $model);
    }
