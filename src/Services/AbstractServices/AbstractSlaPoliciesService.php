...
/**
 * This class is responsible from managing the data for SlaPolicies
 *
...
class AbstractSlaPoliciesService
{
    public static function get(?SlaPoliciesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new SlaPoliciesQueryFilter($request);
        }
        ...
        $model = SlaPolicies::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?SlaPolicies
    {
        return SlaPolicies::findByRef($ref);
    }

    public static function getActions()
    {
        $model = SlaPolicies::class;
    ...
    {
        $object = SlaPolicies::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Support\SlaPolicies')
            ->first();
     ...
     *
     * @param  $id
     * @return SlaPolicies|null
     */
    public static function getById($id) : ?SlaPolicies
    {
        return SlaPolicies::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = SlaPolicies::where('uuid', $uuid)->first();
     ...
     * @return SlaPolicies
     */
    public static function updateRaw(array $data) : ?SlaPolicies
    {
    ...
    {
        $model = SlaPolicies::where('uuid', $id)->first();
