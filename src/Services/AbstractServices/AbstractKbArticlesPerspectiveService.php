...
/**
 * This class is responsible from managing the data for KbArticlesPerspective
 *
 * Class KbArticlesPerspectiveService.
 *
...
class AbstractKbArticlesPerspectiveService
{
    public static function get(KbArticlesPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new KbArticlesPerspectiveQueryFilter($request);
        }
        ...
        $model = KbArticlesPerspective::filter($filter);
    ...
    {
        return KbArticlesPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?KbArticlesPerspective
    {
        return KbArticlesPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = KbArticlesPerspective::class;
    ...
    {
        $object = KbArticlesPerspective::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Support\KbArticlesPerspective')
            ->first();
     ...
     *
     * @param  $id
     * @return KbArticlesPerspective|null
     */
    public static function getById($id) : ?KbArticlesPerspective
    {
        return KbArticlesPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = KbArticlesPerspective::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return KbArticlesPerspective
     */
    public static function updateRaw(array $data) : ?KbArticlesPerspective
    {
    ...
    {
        $model = KbArticlesPerspective::where('uuid', $id)->first();
