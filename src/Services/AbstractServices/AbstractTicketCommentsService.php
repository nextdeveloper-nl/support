...
class AbstractTicketCommentsService
{
    public static function get(TicketCommentsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new TicketCommentsQueryFilter($request);
        }
        ...
        $model = TicketComments::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?TicketComments
    {
        return TicketComments::findByRef($ref);
    }

    public static function getActions()
    {
        $model = TicketComments::class;
    ...
    {
        $object = TicketComments::where('uuid', $objectId)->first();

        $action = '\\NextDeveloper\\Support\\Actions\\TicketComments\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return TicketComments|null
     */
    public static function getById($id) : ?TicketComments
    {
        return TicketComments::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = TicketComments::where('uuid', $uuid)->first();
     ...
     */
    public static function updateRaw(array $data) : ?TicketComments
    {
    ...
    {
        $model = TicketComments::where('uuid', $id)->first();
