...
class AbstractTicketsService
{
    public static function get(TicketsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new TicketsQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Tickets
    {
        return Tickets::findByRef($ref);
    }
    ...
    {
        $object = Tickets::where('uuid', $objectId)->first();

        $action = '\\NextDeveloper\\Support\\Actions\\Tickets\\' . Str::studly($action);
     ...
     * @return Tickets|null
     */
    public static function getById($id) : ?Tickets
    {
    ...
    {
        try {
            $obj = Tickets::where('uuid', $uuid)->first();
     ...
     * @return Tickets
     */
    public static function updateRaw(array $data) : ?Tickets
    {
    ...
    {
        $model = Tickets::where('uuid', $id)->first();
