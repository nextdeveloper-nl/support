...
class AbstractAgentExpertisesService
{
    public static function get(AgentExpertisesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AgentExpertisesQueryFilter($request);
        }
        ...
        $model = AgentExpertises::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?AgentExpertises
    {
        return AgentExpertises::findByRef($ref);
    }

    public static function getActions()
    {
        $model = AgentExpertises::class;
    ...
    {
        $object = AgentExpertises::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Support\AgentExpertises')
            ->first();
     ...
     *
     * @param  $id
     * @return AgentExpertises|null
     */
    public static function getById($id) : ?AgentExpertises
    {
        return AgentExpertises::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = AgentExpertises::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return AgentExpertises
     */
    public static function updateRaw(array $data) : ?AgentExpertises
    {
    ...
    {
        $model = AgentExpertises::where('uuid', $id)->first();
