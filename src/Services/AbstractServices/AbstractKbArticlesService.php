...
class AbstractKbArticlesService
{
    public static function get(?KbArticlesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new KbArticlesQueryFilter($request);
        }
        ...
        $model = KbArticles::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?KbArticles
    {
        return KbArticles::findByRef($ref);
    }

    public static function getActions()
    {
        $model = KbArticles::class;
    ...
    {
        $object = KbArticles::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Support\KbArticles')
            ->first();
     ...
     *
     * @param  $id
     * @return KbArticles|null
     */
    public static function getById($id) : ?KbArticles
    {
        return KbArticles::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = KbArticles::where('uuid', $uuid)->first();
     ...
     * @return KbArticles
     */
    public static function updateRaw(array $data) : ?KbArticles
    {
    ...
    {
        $model = KbArticles::where('uuid', $id)->first();
