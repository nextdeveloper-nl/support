...
/**
 * This class is responsible from managing the data for Csats
 *
 * Class CsatsService.
 *
...
class AbstractCsatsService
{
    public static function get(?CsatsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new CsatsQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Csats
    {
        return Csats::findByRef($ref);
    }
    ...
    {
        $object = Csats::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\Support\Csats')
            ->first();
     ...
     * @return Csats|null
     */
    public static function getById($id) : ?Csats
    {
        return Csats::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Csats::where('uuid', $uuid)->first();
     ...
     * @return Csats
     */
    public static function updateRaw(array $data) : ?Csats
    {
    ...
    {
        $model = Csats::where('uuid', $id)->first();
