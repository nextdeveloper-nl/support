...
class AbstractCommentsService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Support\Comments', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\Support\Comments', $model);
        ...
        Events::fire('updated:NextDeveloper\Support\Comments', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Support\Comments', $model);
